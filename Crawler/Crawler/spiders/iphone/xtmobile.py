...
class iphone_xtmobile(scrapy.Spider):
    name = 'iphone_xtmobile'
    ...
    script = """
            function main(splash)
                ...
                assert(splash:runjs('document.getElementsByClassName("pagination-more")[0].getElementsByTagName("a")[0].click();'))
    ...
    def parse(self, response):
        ...
        for item in items:
            ...
            for information in informations:
                label = information.find('span').text
