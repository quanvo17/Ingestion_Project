...
class watch_shopapple123(scrapy.Spider):
    name = 'watch_shopapple123'
    start_urls = ["https://shopapple123.com/apple-watch-4"]
    script = """
    ...
    def parse(self, response):
        ...
        for item in items:
            ...
            thongtin['price'] = str(item.css('span.price_new::text').get()).replace('₫', 'VND')
